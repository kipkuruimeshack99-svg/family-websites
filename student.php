...
// Fetch all students
$sql = "SELECT * FROM category WHERE occupation='Student' ORDER BY id DESC";
...
<title>Student Members - Family Website</title>
<style>
...
<?php else: ?>
<p style="text-align:center; color:red;">No student members found.</p>
<?php endif; ?>
