...
// Fetch all employed users
$sql = "SELECT * FROM category WHERE occupation='Employed' ORDER BY id DESC";
...
<title>Employed Members - Family Website</title>
<style>
...
<tr>
    ...
    <td><?php echo htmlspecialchars($row['workplace']); ?></td>
    <td><?php echo htmlspecialchars($row['created_at']); ?></td>
</tr>
<?php endwhile; ?>
</table>
<?php else: ?>
<p style="text-align:center; color:red;">No employed members found.</p>
<?php endif; ?>
